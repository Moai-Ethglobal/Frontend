    ...
    <main className="min-h-dvh bg-white text-neutral-950">
      <div className="mx-auto w-full max-w-3xl px-6 py-10">
        <header className="flex items-center justify-between">
          <Link className="text-sm font-medium text-neutral-900" href="/">
            Moai
          </Link>
        ...
        <p className="mt-4 text-pretty text-base leading-7 text-neutral-800">
          A moai is a group of individuals who trust each other and share
          lifelong bonds that helps them feel connected, battling loneliness and
          financial hardships throughout their old age.
        </p>
        ...
        <ul className="mt-4 list-disc space-y-3 pl-5 text-base leading-7 text-neutral-800">
          <li>
            Anyone can create a group (called a moai) and send invites over
            email or share a link to join.
          </li>
          <li>
            A member can join via an invite link. Each member can only be part
            of one group.
          </li>
        ...
        <ul className="mt-4 list-disc space-y-3 pl-5 text-base leading-7 text-neutral-800">
          <li>
            Every month, each member pays a fixed amount before a set date.
          </li>
          <li>
          ...
          <li>
            Consistent savings can be invested each month into a low-risk,
            easily liquidifiable yield strategy.
          </li>
        </ul>
        ...
        <p className="mt-3 text-base leading-7 text-neutral-800">
          When a member has an emergency situation, they can raise a request
          with the amount they need (or anyone on their behalf). At least 51% of
          the members need to approve for it to pass through, and the amount is
        ...
        <p className="mt-3 text-base leading-7 text-neutral-800">
          ...
          decentralized moai helps sustain money and resolve geographic
          dispersion for reasons like jobs and studies. This is solved with
          Huddle.
        </p>
        ...
        <ul className="mt-4 list-disc space-y-3 pl-5 text-base leading-7 text-neutral-800">
          ...
          <li>
            ...
            request. Upon approval of at least 2 members, the demised member
            will be removed from the moai.
          </li>
        </ul>
